...
<html>
    ...
    <body>
        ...
        <div class="text-bar">
            <p class="main-text" id="garamond">Criminal Release</p>
        </div>
                ...
                <%
                    ...
                    try {
                        ...
                        if (cjhResult == 1 && crimUpdateResult == 1){
                            ...
                            out.println("<table>");
                            out.println("<thead>");
                            out.println("<tr><th colspan='2' style='color: white; font-weight: bold;'>Criminal Released Successfully!</th></tr>");
                            out.println("</thead>");
                            out.println("<tbody>");
