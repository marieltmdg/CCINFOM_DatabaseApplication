...
<html>
    <head>
        ...
        <title>Retrieve Officer</title>
    </head>
    <body> 
        <h2>Retrieve Officer</h2>
        <%
            ...
            if (officerBadgeNumber != null) {
                try {
                    ...
                    if (check == 1) {
                        ...
                        out.println("<form action ='update_officer_jailCode.html' method='post'>");
                        out.println("<input type='submit' value='Update Jail Code'>");
                        out.println("</form>");
                        out.println("<form action ='update_officer_active.html' method='post'>");
